...
```{r}
# This is a comment
#another line# pounds signs do not end the comment
```
...
```{r}
substr("How much wood could a wood chuck chuck?", start <- 4, stop <-13)
```
...
#help(sub) # help function gives a description but in a different window
```
